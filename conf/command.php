<?php
    ...
    function ekopre($var){
        echo '<div>';
        echo '<h3 style="color:#ff0000">Debug Section</h3>';
        echo '<pre>';
        print_r($var);
        echo '</pre>';
        echo '</div>';
    ...
    function actionMenu() {
        ...
        if (!cekSessiPasien()) {
            if($aksi=="Home"){
                echo "<li><a href='#top' class='smoothScroll' style='color:#ffffff;'>Home</a></li>
                     <li><a href='#news' class='smoothScroll' style='color:#ffffff;'>Jadwal Praktek</a></li>
                     <li><a href='index.php?act=FasilitasKamar' class='smoothScroll' style='color:#ffffff;'>Fasilitas & Tarif</a></li>
                     <li><a href='#team' class='smoothScroll' style='color:#ffffff;'>Dokter Kami</a></li>
                     <li><a href='#about' class='smoothScroll' style='color:#ffffff;'>Tentang Kami</a></li>
                ...
                echo "<li><a href='index.php?act=Home' class='smoothScroll' style='color:#ffffff;'>Home</a></li>
                     <li><a href='index.php?act=FasilitasKamar' class='smoothScroll' style='color:#ffffff;'>Kamar</a></li>
                     <li><a href='index.php?act=FasilitasRadiologi' class='smoothScroll' style='color:#ffffff;'>Radiologi</a></li>
                     <li><a href='index.php?act=FasilitasLaborat' class='smoothScroll' style='color:#ffffff;'>Laborat</a></li>
                     <li><a href='index.php?act=FasilitasOperasi' class='smoothScroll' style='color:#ffffff;'>Operasi</a></li>
                     <li class='appointment-btn'><a href='index.php?act=Home#appointment'>Buat Janji/Booking</a></li>";
            }else{
                echo "<li><a href='index.php?act=Home#top' class='smoothScroll' style='color:#ffffff;'>Home</a></li>
                     <li><a href='index.php?act=Home#about' class='smoothScroll' style='color:#ffffff;'>Tentang Kami</a></li>
                     <li><a href='index.php?act=Home#news' class='smoothScroll' style='color:#ffffff;'>Jadwal Praktek</a></li>
                     <li><a href='index.php?act=FasilitasKamar' class='smoothScroll' style='color:#ffffff;'>Fasilitas & Tarif</a></li>
                     <li><a href='index.php?act=Home#team' class='smoothScroll' style='color:#ffffff;'>Dokter Kami</a></li>
                     <li class='appointment-btn'><a href='index.php?act=Home#appointment'>Buat Janji/Booking</a></li>";
            }
        }
    }
    ...
    // <li><a href='index.php?act=FasilitasOnline' class='smoothScroll' style='color:#ffffff;'>Konsultasi Online</a></li>
