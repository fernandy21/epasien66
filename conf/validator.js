...
// function validasiIsi(param)
// {
// 	$(param).fetch(function (data) {
// 		state = false
...
// 		});
// 		if( !state){
// 			alert("diisi bro kd boleh kosong")
// 		}
// 	})
//  		var TxtIsi1Nam		= document.getElementById("TxtIsi1Nam");
//         var MsgIsi1Nam 		= document.getElementById("MsgIsi1Nam");
 	
// 		var TxtIsi1  		= document.getElementById("TxtIsi1");
//         var MsgIsi1 		= document.getElementById("MsgIsi1");
 	
// 		var TxtIsi1Book  	= document.getElementById("TxtIsi1Book");
//         var MsgIsi1Book 	= document.getElementById("MsgIsi1Book");

//         var TxtIsi2Alamat	= document.getElementById("TxtIsi2Alamat");
//         var MsgIsi2Alamat	= document.getElementById("MsgIsi2Alamat");
        
// 		var TxtIsi2  		= document.getElementById("TxtIsi2");
//         var MsgIsi2 		= document.getElementById("MsgIsi2");
		
// 		var TxtIsi2Book		= document.getElementById("TxtIsi2Book");
//         var MsgIsi2Book		= document.getElementById("MsgIsi2Book");

//         var TxtIsi3  		= document.getElementById("TxtIsi3");
//         var MsgIsi3 		= document.getElementById("MsgIsi3");
        
// 		var TxtIsi3Cap 		= document.getElementById("TxtIsi3Cap");
//         var MsgIsi3Cap 		= document.getElementById("MsgIsi3Cap");
...
//  	if (TxtIsi1Nam.value.length == 0)
//  	{
//   		kedip("document.getElementById('TxtIsi1Nam').style.backgroundColor = ");
//   		MsgIsi1Nam.innerHTML = "<br>Maaf, field ini belum diisi";
//   		TxtIsi1Nam.focus();
//   		return false;
//  	}
//  	else
...
//  	}
//  	else
// 	 if (TxtIsi1Book.value.length == 0)
//  	{
//   		kedip("document.getElementById('TxtIsi1Book').style.backgroundColor = ");
//   		MsgIsi1Book.innerHTML = "<br>Maaf, field ini belum diisi";
//   		TxtIsi1Book.focus();
//   		return false;
//  	}
//  	else
//         if (TxtIsi2Alamat.value.length == 0)
//  	{
//   		kedip("document.getElementById('TxtIsi2Alamat').style.backgroundColor = ");
//   		MsgIsi2Alamat.innerHTML = "<br>Maaf, field ini belum diisi";
//   		TxtIsi2Alamat.focus();
//   		return false;
// 	}
// 	else
...
//    }
//    else
// 	  if (TxtIsi2Book.value.length == 0)
//    {
// 		kedip("document.getElementById('TxtIsi2Book').style.backgroundColor = ");
// 		MsgIsi2Book.innerHTML = "<br>Maaf, field ini belum diisi";
// 		TxtIsi2Book.focus();
// 		return false;
//   }
// 	   else
...
// 	}
// 	   else
// 	   if (TxtIsi3Cap.value.length == 0)
// 	{
// 		 kedip("document.getElementById('TxtIsi3Cap').style.backgroundColor = ");
// 		 MsgIsi3Cap.innerHTML = "<br>Maaf, field ini belum diisi";
// 		 TxtIsi3Cap.focus();
// 		 return false;
// 	}
// 		  else
